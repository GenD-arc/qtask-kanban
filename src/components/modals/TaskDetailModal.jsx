 ...
 *
 * Sections (top → bottom):
 *   1. Header       — title, severity badge, Edit / Close buttons
 *   2. Details      — view or edit mode (assignee, severity, date, status)
 *   3. Progress bar
 *   4. Subtasks     — checklist + add form
 *   5. Attachments  — FileUpload component (upload, preview, download, delete)
 *   6. Footer       — delete task with inline confirmation
 */
        ...
        <div className="p-6 space-y-4 border-b border-gray-100">
          ...
          {!editMode ? (
            ...
            <div className="space-y-3">
              <p className="text-xs text-blue-600 font-medium">Editing assignee, severity, and target date</p>
